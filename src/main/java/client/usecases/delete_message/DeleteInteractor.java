...
import server.usecases.delete_message.*;
import server.usecases.delete_message.DeleteDSGateway;
...
public class DeleteInteractor implements DeleteInputBoundary {
    ...
    final server.usecases.delete_message.DeleteDSGateway dataBase;
