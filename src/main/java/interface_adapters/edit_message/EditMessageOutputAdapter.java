...
public class EditMessageOutputAdapter implements EditOutputBoundary {
    ...
    public void EditMessage(EditOutputModel edit_model) {
        ...
        char separator = 30;
        String msgContent = String.join(String.valueOf(separator), String.valueOf(edit_model.msgUid), String.valueOf(edit_model.senderUid),
                String.valueOf(edit_model.chatUid), edit_model.edited_content, edit_model.edited_content, edit_model.time);
