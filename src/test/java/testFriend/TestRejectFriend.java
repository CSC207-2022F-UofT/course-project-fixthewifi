...
//        friendController.requestFriend(0);
        ...
        //func("$reg a 123")
        // in interactor, it cleans data for duplicate pririorly
    ...
    /**
     * Assume friend request is sent. Assert if the key code in
     * feature can reject the friend and do not add something
     * Noticed that user have no friend originally
     */
    @Test
    public void testReject() {
        Database database = new Database("testuser.csv", "testchat.csv");
        String[] a = database.readUser(0);
        //reject friend code:
        //nothing happens in database of friend list
        Assertions.assertNotEquals("-0", a[9]);
    }
}
